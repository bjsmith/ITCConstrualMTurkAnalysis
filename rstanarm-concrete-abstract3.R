...
data.itc.bestsubj[Group=="BlockDesign_concrete_first",.N,by=SubjectUniqueID]
model.stan.rr.bestsubj.concrete_to_abstract3<-stan_glmer(Choice01~
                             scale(TrialIdItcSC)+
                             scale(LogKIndiff)+
...
summary(model.stan.rr.bestsubj.concrete_to_abstract3)

save( model.stan.rr.bestsubj.concrete_to_abstract3,file="../../../data/ITCConstrual_mTurkExp/stanmodel-ca3.RData")

# 
# model.glmer.rr.bestsubj.concrete_to_abstract3<-glmer(Choice01~
#                                                            scale(TrialIdItcSC)+
#                                                            scale(LogKIndiff)+
#                                                            AbstractionLevel+
#                                                            salienceCondition+
