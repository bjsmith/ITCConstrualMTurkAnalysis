...
qualtrics.data<-get_qualtrics_data(paste0(data.directory,"raw_files/exp20180321/ITCConstrual-attempt4_March+22,+2018_16.47_data.csv"))# read.csv()
...
metaloop_dir<-"~/GDrive/neural-construal-level/code/SmithAdaptConstrualITCmTurk/html-gen/"
raw.psychopy.filedir<-paste0(data.directory,"raw_files/",localdata_subdir,task_version,"/")
condition_info<-read.csv("~/GDrive/neural-construal-level/code/SmithAdaptConstrualITCmTurk/condition_info.csv",,stringsAsFactors = FALSE)
